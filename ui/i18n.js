...
const STR = {
  ...
  "pos.sub": ["What is open on the exchange right now. A robot's positions stay open when the app closes: the robot stops, the position does not.",
              "Lo que hay abierto en el exchange ahora. Las posiciones de un robot quedan abiertas al cerrar la aplicación: el robot se detiene, la posición no."],
  "pos.ninguna": ["Nothing open on the exchange.", "No hay nada abierto en el exchange."],
  "pos.cantidad": ["size", "cantidad"],
  "pos.entrada": ["entry", "entrada"],
  "pos.abierto": ["open P&L", "resultado abierto"],
  "pos.con_stop": ["stop on the exchange", "con stop puesto"],
  "pos.sin_stop": ["no stop", "sin stop"],
  "pos.cerrar": ["Close", "Cerrar"],
  "pos.del_robot": ["a robot is watching it", "la mira un robot"],
  "pos.del_robot_ayuda": ["It closes from the robot's own card, which stops it first. Closing behind its back leaves it deciding on a world that changed.",
                          "Se cierra desde la tarjeta del robot, que primero lo detiene. Cerrarla por atrás lo deja decidiendo sobre un mundo que cambió."],
  "pos.confirmar": ["Close the {sim} position at market? It cannot be undone.",
                    "¿Cerrar la posición de {sim} a mercado? No se puede deshacer."],
  "pos.cerrada": ["{sim} closed.", "{sim} cerrada."],
  ...
  "res.solapa": ["Summary", "Resumen"],
  "res.sub": ["How the validated strategies did, all together. Nothing here is recalculated: every number was stored the day each strategy was validated.",
              "Cómo les fue a las validadas, todas juntas. Acá no se recalcula nada: cada número se guardó el día que la estrategia se validó."],
  "res.pocas": ["Not enough validated strategies yet", "Todavía hay pocas validadas"],
  "res.pocas_sub": ["There are {n}. Below twenty, these percentages describe three or four strategies and read like a law.",
                    "Hay {n}. Por debajo de veinte, estos porcentajes describen tres o cuatro estrategias y se leen como una ley."],
  "res.k_validadas": ["validated so far", "validadas hasta hoy"],
  "res.k_pasaron": ["passed · {n} of them", "pasaron · {n} de ellas"],
  "res.k_ef": ["median efficiency", "eficiencia mediana"],
  "res.k_robustas": ["robust · {n} overfitted", "robustas · {n} sobreajustadas"],
  "res.disp_t": ["The generation score against what survived",
                 "El score de la generación contra lo que sobrevivió"],
  "res.disp_sub": ["One dot per strategy. Further right, better score in the backtest. Higher up, more edge kept out of sample. The line marks the {piso} floor below which the verdict is overfitted, wherever it won.",
                   "Un punto por estrategia. Más a la derecha, mejor score en el backtest. Más arriba, más ventaja conservada fuera de muestra. La línea marca el piso de {piso} por debajo del cual el veredicto es sobreajustada, gane donde gane."],
  "res.piso": ["floor {piso} · below, overfitted", "piso {piso} · debajo, sobreajustada"],
  "res.eje_x": ["generation score", "score de la generación"],
  "res.eje_y": ["out-of-sample efficiency", "eficiencia fuera de muestra"],
  "res.dice": ["<b>What it says:</b> the generation score barely anticipates whether a strategy will survive. The correlation between score and efficiency is <b>{r}</b> over {n} strategies, where 0 would be no relation and 1 a perfect one. In the lowest score band {baja} passed; in the highest, {alta}. That is why validation exists as a separate step, and here it is measured instead of asserted.",
               "<b>Lo que dice:</b> el score de la generación casi no anticipa si la estrategia va a sobrevivir. La correlación entre score y eficiencia es de <b>{r}</b> sobre {n} estrategias, donde 0 sería ninguna relación y 1 una relación perfecta. En la franja más baja de score pasaron {baja}, y en la más alta {alta}. Ésa es la razón por la que la validación existe como paso aparte, y acá se mide en vez de afirmarse."],
  "res.franjas_t": ["How many pass, by score band", "Cuántas pasan, por franja de score"],
  "res.franjas_sub": ["The same question, counted. The number on the right is how many were validated in that band.",
                      "La misma pregunta, contada. El número de la derecha es cuántas se validaron en esa franja."],
  "res.ventanas_t": ["Windows won", "Ventanas ganadas"],
  "res.ventanas_sub": ["Of the windows it never saw, how many it ended positive in.",
                       "De las ventanas que nunca vio, en cuántas terminó en positivo."],
  "res.mercados_t": ["Where it pays to keep generating", "Dónde conviene seguir generando"],
  "res.mercados_sub": ["Survival rate per instrument. Only those with five validated or more: below that the percentage is noise.",
                       "Tasa de supervivencia por instrumento. Sólo los que tienen cinco validadas o más: con menos, el porcentaje es ruido."],
  "res.mercados_fuera": ["{n} instruments with fewer than five validated are left out.",
                         "Quedan afuera {n} instrumentos con menos de cinco validadas."],
  "res.de_n_pasaron": ["{ok} of {n} passed", "{ok} de {n} pasaron"],
  "res.de_n": ["{ok} of {n}", "{ok} de {n}"],
  "res.n_estrategias": ["{n} strategies", "{n} estrategias"],
