...
const STR = {
  ...
  "fp.encontradas": ["Found", "Encontradas"],
  "fp.probar": ["Test", "Probar"],
  "fp.probar_elegidas": ["Test the {n} selected", "Probar las {n} elegidas"],
  "fp.probar_todas": ["Test all", "Probar todas"],
  "fp.anual": ["annual", "anual"],
  "fp.caida": ["drawdown", "caída"],
  "fp.tramos": ["{g} of {n} stretches", "{g} de {n} tramos"],
  "fp.afuera": ["out of sample", "afuera"],
  ...
  "fp.vacia": ["All tested.", "Todo probado."],
  "fp.buscar_mas": ["Search for more →", "Buscar más →"],
  "fp.vacia_ok": ["Nothing has held yet.", "Todavía no aguantó ninguna."],
  ...
  "op.modo_una_sub": ["One robot on one symbol, with the share of the account the autopilot would give it.",
                      "Un robot sobre un símbolo, con la porción de la cuenta que le daría el piloto."],
  "op.modo_conjunto_sub": ["Several at once, each on its own symbol and with the account split between them.",
                           "Varias a la vez, cada una sobre su símbolo y con la cuenta repartida entre ellas."],
  "op.elegi_una": ["Pick one to turn on", "Elegí una para encender"],
  "op.elegi_varias": ["Pick two or more: the account gets split between them",
                      "Elegí dos o más: la cuenta se reparte entre ellas"],
  "op.elegidas_n": ["{n} picked", "{n} elegidas"],
  "op.repetido": ["Two of these run on {sim}: that is one bet with two names, not two. The autopilot allows one robot per symbol.",
                  "Dos de éstas corren sobre {sim}: eso es una apuesta con dos nombres, no dos. El piloto deja un robot por símbolo."],
  "op.encender_conjunto_n": ["Turn on the set of {n}", "Encender el conjunto de {n}"],
  "op.elegir_aprobada": ["Choose one that held…", "Elegí una aprobada…"],
  "op.encender_btn": ["Turn on in demo", "Encender en demo"],
  "op.sin_aprobadas": ["Nothing to turn on yet. Strategies get here by holding up in Test.", "Todavía no hay aprobadas para encender. Salen de Probar."],
  ...
  "run.listo": ["{n} strategies found.", "{n} estrategias encontradas."],
  ...
  "bank.ya_en_probar": ["in Test", "en Probar"],
  "bank.ya_de_esas": ["{m} already in Test", "{m} ya en Probar"],
  "bank.mandar_n": ["Send {n} to Test", "Mandar {n} a Probar"],
  ...
  "bank.pruned": ["The databank was full: the {n} oldest were dropped",
  ...
  "expl.ent3_t": ["The ones worth keeping go to Test, with their instrument, timeframe and costs. They survive any new search.",
  ...
  "ciclo.sin_probar": ["{n} not tested yet", "{n} sin probar"],
  ...
  "ciclo.inoperables": ["{n} the robot cannot run", "{n} que el bot no puede encender"],
  "ciclo.toca_minar": ["{h} hours since the last search", "pasaron {h} horas del último minado"],
  "ciclo.proximo": ["next search in {h} hours", "el próximo minado en {h} horas"],
  ...
  "wf.no_se_pudo": ["Could not test it", "No se pudo probar"],
